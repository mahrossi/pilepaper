...
\begin{itemize}
\item Remove parameters that are already in Marx paper -- just refer to it \mr{OK}
\item Introduce IR spectrum as discussed with David \mr{OK}
\item Discuss the two molecules at the same time -- they are the same, just say
that CH4 shows less of the curvature problem as discussed in the OTHER Marx paper. \mr{OK} 
Say that RPMD resonances are not healed by an angular potential because they are related
to vibrations as opposed to relaxation of the ring polymer as in CMD curvature problem \mr{OK}
...
position and amplitude as a function of T for PILE and CMD -- not RPMD where there are multiple peaks. \mr{OK}
