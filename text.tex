...
T=350K was considered). We add also data for classical simulations.
The form of the peaks proved to be almost perfectly Lorentzian in all cases,
except for the points at 1000K, in which the peaks were slightly skewed to the right.
...
with only FWHM=11 $cm^{-1}$ at 100K , but the width increases with temperature.
The peak position of the classical simulation is more than 100 cm$^{-1}$
blue-shifted with respect to the exact result, though.
At 1000K, all methods approach the same classical limit,
and show essentially the same peak broadening. The position of the
classical peak at 1000 K is still blue-shifted with respect to the semi-classical
simulations. Given that a vibration at 3500 cm$^{-1}$ corresponds to a temperature
of around 2500 K, we expect that the exact classical limit to be reached at only
much higher temperatures, where the molecule would already dissociate.
...
Finally, the critical-damping PILE spectrum shows neither resonances, or curvature-related red shift. 
...
of capturing subtle, coherent quantum effects. Methods like CMD, RPMD and the its PILE variant should
